...
BTN_P_REGION = "📍 Район"
BTN_P_CATS = "🧰 Интересы"
BTN_P_NOTIFY_ON = "🔔 Уведомления: вкл"
BTN_P_NOTIFY_OFF = "🔕 Уведомления: выкл"
BTN_P_INVITE = "🎁 Пригласить друга"
BTN_P_COMPLAIN = "🆘 Жалоба"
BTN_P_ROLE = "🔄 Сменить роль"
BTN_P_HELP = "ℹ️ Помощь"

PROFILE_HINT = "Меняйте настройки кнопками ниже 👇"
